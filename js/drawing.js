...
game.redraw = function () {
    ...
    game.score = Math.round(-game.player.highestY / (3 * game.options.tileHeight)); // Cập nhật điểm số
...
game.requestRedraw = function () {
    ...
    if (game.isOver) {
        ...
        game.context.fillText("Points: " + game.score, game.canvas.width / 2, game.canvas.height / 2 + 100);
    }
}
